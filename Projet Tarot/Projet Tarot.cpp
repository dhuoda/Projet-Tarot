...
// Projet Tarot.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CProjetTarotApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CProjetTarotApp

CProjetTarotApp::CProjetTarotApp()
{
...
// Seul et unique objet CProjetTarotApp

CProjetTarotApp theApp;


// initialisation de CProjetTarotApp

BOOL CProjetTarotApp::InitInstance()
{
